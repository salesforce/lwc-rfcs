...
Technically this is a breaking change, because developers may have already defined a property named `refs` in their component. We will need to do some analysis of potential breakage and find workarounds (e.g. ESLint rules).
